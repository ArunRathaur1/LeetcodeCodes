class Solution {
public:
    bool answer(string s1, string s2,string s3,int i1,int i2,int i3,int n1,int n2,int n3,vector<vector<vector<int>>>&dp){
    ...
    bool isInterleave(string s1, string s2, string s3) {
        ...
        return answer(s1,s2,s3,0,0,0,s1.length(),s2.length(),s3.length(),dp);
    }
};